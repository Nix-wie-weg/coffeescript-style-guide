...
UTF-8 is the only allowed file encoding.
...
If multiple lines are required by the description, indent subsequent lines to
...
Whenever DOM elements are used for interaction with coffeescript add a special 
prefix. This allows for independent styling.

```html
<body>
  <div class="banner js_banner"></div>
</body>
```
...
We encourage the use of **standalone** `@`:
...
[polar-cs-styleguide]: https://github.com/polarmobile/coffeescript-style-guide
